...
const F47_RFID_COLUMNS: ColumnConfig[] = [
  ...
  { header: 'Style Desc', keys: ['style_des', 'Style_Des', 'style_desc'], width: 1.5, align: 'left' },
  ...
  { header: 'Color', keys: ['color_des', 'Color_Des', 'color'], width: 1.0, align: 'left' },
  { header: 'Item Desc', keys: ['item_des', 'Item_Des', 'item_desc'], width: 1.5, align: 'left' },
