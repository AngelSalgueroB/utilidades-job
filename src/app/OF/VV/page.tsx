...
import { VV_CONFIGS, ProductConfig } from './config';
            ...
            <View style={styles.middleSection}>
              <View style={styles.moContainer}>
                ...
                <View style={styles.moRow}>
                    <Text style={{ ...styles.moText, flex: 1, fontWeight: 'bold' }}>{mo}</Text>
                    <Text style={{ ...styles.moText, flex: 1, textAlign: 'right' }}>{sumQty}</Text>
                </View>
                <View style={styles.totalRow}>
                  <Text style={{ ...styles.moText, flex: 1, fontWeight: 'bold' }}>TOTAL</Text>
    ...
    <main className="container mx-auto px-4 py-8 max-w-6xl">
      ...
      <div className="grid gap-6">
        <Card className="border-l-4 border-l-amber-500 shadow-md">
            <CardHeader className="pb-3"><CardTitle className="text-lg flex gap-2"><FileText className="h-5 w-5 text-amber-600"/> Datos Manuales</CardTitle></CardHeader>
            <CardContent>
                <div><Label>Client Name</Label><Input value={manualClient} onChange={e => setManualClient(e.target.value)} placeholder="Ingrese Nombre del Cliente" className="border-amber-200" /></div>
            </CardContent>
        </Card>
