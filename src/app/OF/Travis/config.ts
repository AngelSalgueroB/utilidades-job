...
const TRTRHKV002_COLUMNS: ColumnConfig[] = [
  ...
  { header: 'Barcode', keys: ['barcode', 'Barcode'], width: 0.8, align: 'center' },
...
export const TRAVIS_CONFIGS: Record<string, ProductConfig> = {
  'trtrhkv002': {
    ...
    logoImageName: 'logosml2.jpg', // Usando el nuevo logo indicado
    headerRow: 0,
    columns: TRTRHKV002_COLUMNS
  },
  // Espacio preparado para el ítem 2 cuando decidas implementarlo
  // 'trtrm9v001': {
  //   id: 'trtrm9v001',
  ...
  //   headerRow: 0,
  //   columns: TRTRHKV002_COLUMNS // A modificar cuando veamos su Excel
  // }
};