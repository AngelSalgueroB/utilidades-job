...
const TB_COLUMNS: ColumnConfig[] = [
  { header: 'Sorting', keys: ['Sorting_No', 'sorting_no', 'Sorting'], width: 0.6, align: 'center' },
  { header: 'Lot', keys: ['Lot_No', 'lot_no', 'Lot'], width: 0.7, align: 'center' },
  { header: 'Color By', keys: ['color_by', 'Color_By'], width: 0.85, align: 'center' },
  { header: 'Un_Key', keys: ['Un_Key', 'un_key'], width: 0.8, align: 'center' },
  { header: 'Unit', keys: ['Unit', 'unit'], width: 0.35, align: 'center' },
  { header: 'G. Name', keys: ['g_name', 'G_Name', 'Cust_Name'], width: 2.8, align: 'center', isUpperCase: true},
  { header: 'Style', keys: ['g_style', 'G_Style', 'Style', 'Style_No'], width: 0.9, align: 'center' },
  { header: 'col_num', keys: ['col_num', 'Col_Num'], width: 0.5, align: 'center' },/*new*/
  { header: 'Color', keys: ['g_color', 'G_Color', 'Color', 'Color_Desc'], width: 1.2, align: 'center' },
  ...
  { header: 'Size', keys: ['Size', 'size', 'us_size'], width: 0.7, align: 'center' },
  ...
  { header: 'Format', keys: ['format', 'Format'], width: 0.35, align: 'center' },
